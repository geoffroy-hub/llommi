...
// ✅ BUG 5 FIX : dispatchContentLoaded() appelée à la fin de chaque chargeur de page
(function() {
    'use strict';
    ...
    // ── Dispatcher l'événement de fin de chargement ──────────────────────────
    ...
    async function loadHomePageContent() {
        ...
        // ✅ BUG 5 FIX : dispatcher l'événement après chargement complet
    ...
    async function loadBlogPageContent() {
        ...
        try {
            ...
            if (!blogs || blogs.length === 0) {
                supabaseSlot.style.display = 'none';
                return;
            }
            supabaseSlot.innerHTML = '';
    ...
    window.MiraLocksContent = {
        ...
        dispatchLoaded: dispatchContentLoaded
    };
